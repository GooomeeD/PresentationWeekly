...
def df_to_table (slide, df, left ,top, colnames=None, col_formatters=None, rounding=None,
                name=None, table_style=None):

    table_style = '{2D5ABB26-0587-4C30-8999-92F81FD0307C}'
    rows, cols = df.shape
    ...
    if table_style is not None:
        ...
        table_graphic[0][-1].text = '{2D5ABB26-0587-4C30-8999-92F81FD0307C}'
